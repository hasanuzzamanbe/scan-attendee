...
if (!function_exists('scanAttendeeAutoload')) {
    /**
     * Plugin autoloader.
     *
     ...
     * @param $class
     */
    function scanAttendeeAutoload($class)
    {
        // Do not load unless in plugin domain.
        $namespace = 'scanAttendee';
    ...
    spl_autoload_register('scanAttendeeAutoload');
}
